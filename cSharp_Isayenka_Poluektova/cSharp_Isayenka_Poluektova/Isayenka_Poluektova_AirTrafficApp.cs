 ...
 * Isayenka_Poluektova_AirTrafficApp.cs
...
{
    class Isayenka_Poluektova_AirTrafficApp
    {
        ...
        public static void AddData() 
        {
            ...
            while (res == "Y")
            {
                ...
                Isayenka_Poluektova_AirTraffic m = new Isayenka_Poluektova_AirTraffic(location, d1, flightCount, passCount, Cnt);
