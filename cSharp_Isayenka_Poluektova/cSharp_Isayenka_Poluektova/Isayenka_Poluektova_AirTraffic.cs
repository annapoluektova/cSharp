/*
 * cSharp_Isayenka_Poluektova - Project
 * Isayenka_Poluektova_AirTraffic.cs
...
namespace _cSharp_Isayenka_Poluektova
{
    public class Isayenka_Poluektova_AirTraffic
    {
        ...
        //Default constructor
        public Isayenka_Poluektova_AirTraffic()
        {

        }
        
        //Constructor
        public Isayenka_Poluektova_AirTraffic(string airLoc, string[] date, uint[] flightcnt, uint[] passcnt, uint numOfFlights)
        {
