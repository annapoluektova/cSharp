...
{
    class Isayenka_Poluektova_SavingsApp
    {
        static void Main(string[] args)
        {
            ...
            Isayenka_Poluektova_Savings firstSavingsObject = new Isayenka_Poluektova_Savings();
        ...
        public static void DisplayWelcome()
        {
            ...
            Console.WriteLine("*                Your Managers are Isayenka, Poluektova!        *");
            Console.WriteLine("*****************************************************************");
        }
